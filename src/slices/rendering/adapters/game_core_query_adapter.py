...
from src.slices.rendering.ports.secondary_ports.board_query_port import (
    IBoardQueryPort,  # Importar el puerto secundario local
)
...
class GameCoreQueryAdapter(IBoardQueryPort):
    """
